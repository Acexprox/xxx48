...
<button 
  ...
  className="hero-button video-demo-button border-2 border-blue-400 text-blue-600 px-8 py-4 rounded-xl font-semibold text-lg hover:border-purple-500 hover:text-purple-600 hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 relative group"
>
...
<button 
  onClick={() => setIsVideoModalOpen(true)}
  className="hero-button video-demo-button border-2 border-blue-400 text-blue-600 px-6 py-3 rounded-xl font-semibold text-base hover:border-purple-500 hover:text-purple-600 hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 relative group"
>
<span className="play-icon-wrapper relative">
